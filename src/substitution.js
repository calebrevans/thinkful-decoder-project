...
const substitutionModule = (function () {
  ...
  //break message up into letters
  //letter by letter
  //find the letter position in the real alphabet
  //find the letter for that position in the fake alphabet
  //add converted letter to list
  //return 
